...
![Codacy branch grade](https://img.shields.io/codacy/grade/https://github.com/kenjimaeda54/Pomodoro-Rect-Typescript/desenvolvedor)

This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app).

# Type scritp com React

### Conceitos e tenicas aplicadas
- Conceitos de type script,generic,interface é type annotation
- Manipulação do don para renderizar novas cores para back ground
- Hooks: useState,useInterval, useEfect
- Documentação do  useInterval --> https://overreacted.io/making-setinterval-declarative-with-react-hooks/
